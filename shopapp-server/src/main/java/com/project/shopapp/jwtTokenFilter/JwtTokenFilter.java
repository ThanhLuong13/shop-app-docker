package com.project.shopapp.jwtTokenFilter;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    private boolean isBypassToken(@NonNull  HttpServletRequest request) {
        ...
        String methodPath = request.getMethod();

        if (requestPath.equals(String.format("%s/orders", apiPrefix)) && methodPath.equals("GET")) {
            return true;
        }

        for(Pair<String, String> bypassToken: bypassTokens) {
            if (requestPath.contains(bypassToken.getFirst()) &&
                    methodPath.equals(bypassToken.getSecond())) {
                return true;
            }
        }
        return false;
